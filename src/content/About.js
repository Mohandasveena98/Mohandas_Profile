  ...
  return (
    <div>
      ...
      <div class="aboutpage">
        ...
        <div>
          <p>
            <span style={{ color: "#67B7D1" }}>Import</span>{" "}
            <strong>"./About";</strong>
          </p>
        </div>
        <div>
          <p>
            <span style={{ color: "#67B7D1" }}>Class</span>{" "}
            <b style={{ color: "#5C5CFF" }}>
              <i>M_Mohandas</i>
            </b>
            ()&#123; &#125;
          </p>
        ...
        <div>
          <p style={{ fontWeight: "10", fontSize: "17px", color: "#A9A9A9" }}>
        ...
        <div>
          {" "}
          <p>
            &nbsp;&nbsp;<span style={{ color: "#67B7D1" }}>Constructor</span>{" "}
            ()&#123;
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span style={{ color: "#ff3333" }}>this</span>.
            <span style={{ color: "#267326" }}>name</span> ={" "}
            <span style={{ color: "#ff661a" }}>'M Mohandas'</span>;
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span style={{ color: "#ff3333" }}>this</span>.
            <span style={{ color: "#267326" }}>dayOfBirthTimestamp</span> ={" "}
            <span style={{ color: "#ffcc00" }}>854345712</span>;
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span style={{ color: "#ff3333" }}>this</span>.
            <span style={{ color: "#267326" }}>email</span> ={" "}
            <span style={{ color: "#ff661a" }}>
        ...
        <div>
          <p>
            &nbsp;&nbsp;<span style={{ color: "#5C5CFF" }}>workExperience</span>{" "}
            ()&#123;
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <span style={{ color: "#67B7D1" }}>return</span>[
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;{" "}
            <span style={{ color: "#ff661a" }}>"2021-now"</span> :{" "}
            <span style={{ color: "#ff661a" }}>
              "C++ developer in ARi global solution"
            </span>{" "}
            &#125;,
          </p>
        </div>
        ...
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;{" "}
            <span style={{ color: "#ff661a" }}>"2020-2021"</span> :{" "}
            <span style={{ color: "#ff661a" }}>
              "Front-end developer in epitas pvt.ltd."
            </span>{" "}
            &#125;
          </p>
        </div>
        ...
        <div>
          <p>
            &nbsp;&nbsp;<span style={{ color: "#5C5CFF" }}>education</span>{" "}
            ()&#123;
          </p>
        </div>
        <div>
        ...
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;{" "}
            <span style={{ color: "#ff661a" }}>"2016-2020"</span> :{""}
            <span style={{ color: "#ff661a" }}>
              "Sahyadri Engg. College, Mangalore — B.E"
            </span>{" "}
            &#125;,
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;{" "}
            <span style={{ color: "#ff661a" }}>"2013-2015"</span> :{""}
            <span style={{ color: "#ff661a" }}>
              "Mary Matha Hr. Sec. School, Theni — HSC"
            </span>{" "}
            &#125;,
          </p>
        </div>
        <div>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#123;{" "}
            <span style={{ color: "#ff661a" }}>"2012-2013"</span> :{""}
            <span style={{ color: "#ff661a" }}>
              "Mary Matha Hr. Sec. School, Theni — SSLC"
            </span>{" "}
            &#125;
          </p>
        </div>
        ...
        <div>
          <p>
            &nbsp;&nbsp;<span style={{ color: "#5C5CFF" }}>skills</span>{" "}
            ()&#123;
          </p>
        </div>
        <div>
